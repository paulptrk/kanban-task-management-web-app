...
export default function TaskCard({ task, index, onTaskClick }) {
  ...
  return (
    <div
      ref={ref}
      onClick={onTaskClick}
      className={`bg-surface w-[280px] cursor-pointer rounded-[8px] px-4 py-[23px] shadow-[0px_4px_6px_0px_rgba(54,78,126,0.1)] transition-transform duration-150 ease-out ${
